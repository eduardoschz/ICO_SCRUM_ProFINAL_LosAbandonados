 ...
 * @author Muffin
 */
public class ContactoScrum_Master extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLLDiseno = new javax.swing.JLabel();
        jLConferencias = new javax.swing.JLabel();
        ...
        jLMiembro_Equipo.setText("Scrum Master");
        ...
        jLabel1.setText("Sánchez Posadas José Eduardo");

        jLabel2.setFont(new java.awt.Font("Berlin Sans FB", 0, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("No. de Cuenta: 313081422");

        jLabel3.setFont(new java.awt.Font("Berlin Sans FB", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Email: jeduardo.schz@gmail.com");
        ...
        jLabel6.setText("Leer revistas de divulgación, me gusta ir a museos, ver memes");

        jLabel7.setFont(new java.awt.Font("Berlin Sans FB", 0, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(59, 59, 59));
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel7.setText("en mis ratos libres, el activismo político en pro de la libertad ");

        jLabel8.setFont(new java.awt.Font("Berlin Sans FB", 0, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(59, 59, 59));
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setText("social, politica y económica; el diseño gráfico, asistir a foros y ");
        ...
        jLabel10.setText("conferencias sobre cómputo cientifico.");

        jLGithub.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jLGithub.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLGithubMouseClicked(evt);
            }
        });
            ...
            .addGroup(jPInformacionLayout.createSequentialGroup()
                ...
                .addGroup(jPInformacionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPInformacionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPInformacionLayout.createSequentialGroup()
                            .addGap(34, 34, 34)
                            .addComponent(jLLibro, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(34, 34, 34)
                            .addComponent(jLMuseo, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(34, 34, 34)
                            .addComponent(jLLDiseno, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(34, 34, 34)
                            .addComponent(jLConferencias, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        try {
            if (Desktop.isDesktopSupported()) {
                ...
                if (desktop.isSupported(Desktop.Action.BROWSE)) {
                    desktop.browse(new URI("https://www.facebook.com/jeduardo.schz"));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void jLTwitterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLTwitterMouseClicked
        try {
            if (Desktop.isDesktopSupported()) {
                Desktop desktop = Desktop.getDesktop();
                if (desktop.isSupported(Desktop.Action.BROWSE)) {
                    desktop.browse(new URI("https://twitter.com/jeduardo_schz"));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void jLInstagramMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLInstagramMouseClicked
        try {
            if (Desktop.isDesktopSupported()) {
                Desktop desktop = Desktop.getDesktop();
                if (desktop.isSupported(Desktop.Action.BROWSE)) {
                    desktop.browse(new URI("https://www.instagram.com/jeduardo.schz/"));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void jLGithubMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLGithubMouseClicked
        try {
            if (Desktop.isDesktopSupported()) {
                Desktop desktop = Desktop.getDesktop();
                if (desktop.isSupported(Desktop.Action.BROWSE)) {
                    desktop.browse(new URI("https://github.com/eduardoschz"));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    }//GEN-LAST:event_jLGithubMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContactoScrum_Master.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ContactoScrum_Master().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel jLConferencias;
    ...
    private javax.swing.JLabel jLLDiseno;
    ...
    public void ponerImagenes(){
        ...
        // Foto SM (Eduardo)
        ImageIcon ImageEduardo = new ImageIcon(System.getProperty("user.dir") + "/src/aragon/ico/imagenes/contacto/Eduardo.jpg");
        Icon iconEduardo = new ImageIcon(ImageEduardo.getImage().getScaledInstance(jLFoto.getWidth(), jLFoto.getHeight(), Image.SCALE_AREA_AVERAGING));
        jLFoto.setIcon(iconEduardo);
        
        /***** Imagenes hobibes *****/
        // Libro
        ImageIcon ImageLibro = new ImageIcon(System.getProperty("user.dir") + "/src/aragon/ico/imagenes/contacto/book.png");
        Icon iconLibro = new ImageIcon(ImageLibro.getImage().getScaledInstance(jLLibro.getWidth(), jLLibro.getHeight(), Image.SCALE_AREA_AVERAGING));
        jLLibro.setIcon(iconLibro);
        
        // Museo
        ImageIcon ImageMuseo = new ImageIcon(System.getProperty("user.dir") + "/src/aragon/ico/imagenes/contacto/Museum.png");
        Icon iconMuseo = new ImageIcon(ImageMuseo.getImage().getScaledInstance(jLMuseo.getWidth(), jLMuseo.getHeight(), Image.SCALE_AREA_AVERAGING));
        jLMuseo.setIcon(iconMuseo);
        
        // Diseno
        ImageIcon ImageDiseno = new ImageIcon(System.getProperty("user.dir") + "/src/aragon/ico/imagenes/contacto/Diseno-Grafico.png");
        Icon iconDiseno = new ImageIcon(ImageDiseno.getImage().getScaledInstance(jLLDiseno.getWidth(), jLLDiseno.getHeight(), Image.SCALE_AREA_AVERAGING));
        jLLDiseno.setIcon(iconDiseno);
    
        // Conferencias
        ImageIcon ImageConferencias = new ImageIcon(System.getProperty("user.dir") + "/src/aragon/ico/imagenes/contacto/conferencias.png");
        Icon iconConferencias = new ImageIcon(ImageConferencias.getImage().getScaledInstance(jLConferencias.getWidth(), jLConferencias.getHeight(), Image.SCALE_AREA_AVERAGING));
        jLConferencias.setIcon(iconConferencias);
        ...
        Icon iconGithub = new ImageIcon(ImageGithub.getImage().getScaledInstance(jLGithub.getWidth(), jLGithub.getHeight(), Image.SCALE_AREA_AVERAGING));
        jLGithub.setIcon(iconGithub);
